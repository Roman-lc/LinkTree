  ...
  return (
    <>
      ...
      <div className="mt-3 text-white" style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
        ...
        <a href="https://github.com/roman-lc" aria-label="GitHub" class="icon" target="_blank">
        ...
        <a href="https://www.linkedin.com/in/rlcasala" aria-label="LinkedIn" class="icon" target="_blank">
        ...
        <a href="https://roman-lc.github.io/devfolio/" aria-label="Proyectos" class="icon" target="_blank">
