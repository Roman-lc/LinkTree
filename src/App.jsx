  ...
  return (
    <>
      ...
      <div className="mt-3 text-white" style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
        ...
        <a href="https://github.com/roman-lc" aria-label="GitHub" className="icon" target="_blank">
        <svg aria-label="GitHub" role="img" viewBox="0 0 16 16" width="24" height="24" fill="currentColor">
          <title>GitHub</title>
          <path className='text-white' d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 
        ...
        <a href="https://www.linkedin.com/in/rlcasala" aria-label="LinkedIn" className="icon" target="_blank">
        <svg aria-label="LinkedIn" role="img" viewBox="0 0 16 16" width="24" height="24" fill="currentColor">
          <title>LinkedIn</title>
          <path className='text-white' d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 
             ...
             -2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016l.016-.025V6.169h-2.4
             c.03.678 0 7.225 0 7.225z"/>
        </svg>
        </a>

        <a href="https://roman-lc.github.io/devfolio/" aria-label="Proyectos" className="icon" target="_blank">
        <svg aria-label="Sitio web" role="img" viewBox="0 0 16 16" width="24" height="24" fill="currentColor">
          <title>Sitio web</title>
          <path className='text-white' d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m7.5-6.923c-.67.204-1.335.82-1.887 1.855A8 8 0 0 0 5.145 4H7.5zM4.09 4a9.3 9.3 0 0 1 .64-1.539 7 7 0 0 1 .597-.933A7.03 7.03 0 0 0 2.255 4zm-.582 3.5c.03-.877.138-1.718.312-2.5H1.674a7 7 0 0 0-.656 2.5zM4.847 5a12.5 12.5 0 0 0-.338 2.5H7.5V5zM8.5 5v2.5h2.99a12.5 12.5 0 0 0-.337-2.5zM4.51 8.5a12.5 12.5 0 0 0 .337 2.5H7.5V8.5zm3.99 0V11h2.653c.187-.765.306-1.608.338-2.5zM5.145 12q.208.58.468 1.068c.552 1.035 1.218 1.65 1.887 1.855V12zm.182 2.472a7 7 0 0 1-.597-.933A9.3 9.3 0 0 1 4.09 12H2.255a7 7 0 0 0 3.072 2.472M3.82 11a13.7 13.7 0 0 1-.312-2.5h-2.49c.062.89.291 1.733.656 2.5zm6.853 3.472A7 7 0 0 0 13.745 12H11.91a9.3 9.3 0 0 1-.64 1.539 7 7 0 0 1-.597.933M8.5 12v2.923c.67-.204 1.335-.82 1.887-1.855q.26-.487.468-1.068zm3.68-1h2.146c.365-.767.594-1.61.656-2.5h-2.49a13.7 13.7 0 0 1-.312 2.5m2.802-3.5a7 7 0 0 0-.656-2.5H12.18c.174.782.282 1.623.312 2.5zM11.27 2.461c.247.464.462.98.64 1.539h1.835a7 7 0 0 0-3.072-2.472c.218.284.418.598.597.933M10.855 4a8 8 0 0 0-.468-1.068C9.835 1.897 9.17 1.282 8.5 1.077V4z"/>
        </svg>
        </a>
